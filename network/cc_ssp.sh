...
docker exec cli peer chaincode invoke -o orderer.centralGoverment.com:7050 -n ssp -C ssp -c '{"Args":["addUser","user1","name1"]}'
sleep 5
...
# docker exec cli peer chaincode invoke -o orderer.centralGoverment.com:7050 -n ssp -C ssp -c '{"Args":["addQuantity","testcontent","hashedcontent","test","test","test"]}'
# sleep 5
